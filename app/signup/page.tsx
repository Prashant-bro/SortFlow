...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      // For now, we'll just show a toast since we're focusing on Google auth
      showToast("Email/password signup not implemented yet. Please use Google Sign-In.", "info")
    } catch (error) {
            ...
            <div className="space-y-6">
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                ...
                >
                  ...
                  <span className="ml-2 font-medium">{isAuthLoading ? "Signing up..." : "Continue with Google"}</span>
                </Button>
              </motion.div>
              ...
              <div className="text-center mt-4">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <Link href="/login" className="text-blue-600 hover:text-blue-700 dark:text-blue-500 font-medium">
                    Sign in
                  </Link>
                </p>
              </div>
